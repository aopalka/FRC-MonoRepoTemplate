...
/**
 * Implementation of a PS4 controller using the WPILib PS5Controller class.
 * <p>
 * Provides access to buttons, triggers, bumpers, sticks, and D-pad (POV) with alert
 * handling for when the controller is disconnected.
 * </p>
 */
public class PS4Controller implements ControllerBase {
    ...
    /**
     * Constructs a new PS4Controller.
     *
